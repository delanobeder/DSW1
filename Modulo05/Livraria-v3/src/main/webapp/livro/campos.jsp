...
<div class="mb-3 row">
	<label class="form-label" for="titulo"><fmt:message key="book.title" /></label>
	<input class="form-control" type="text" id="titulo" name="titulo" size="45" required value="${livro.titulo}" />
</div>
<div class="mb-3 row">
	<label class="form-label" for="autor"><fmt:message key="book.author" /></label>
	<input class="form-control" type="text" id="autor" name="autor" size="45" required value="${livro.autor}" />
</div>
<div class="mb-3 row">
	<label class="form-label" for="editora"><fmt:message key="book.publisher" /></label>
...
<div class="mb-3 row">
	<label class="form-label" for="ano"><fmt:message key="book.year" /></label>
	<input class="form-control" type="number" id="ano" name="ano" size="5" required min="1500" value="${livro.ano}" />
</div>
<div class="mb-3 row">
	<label class="form-label" for="preco"><fmt:message key="book.price" /></label>
